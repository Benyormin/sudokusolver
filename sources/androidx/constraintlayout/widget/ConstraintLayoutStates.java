...
public class ConstraintLayoutStates {
    ...
    private void load(android.content.Context r10, int r11) {
        /*
            ...
            r3 = 0
            r4 = 0
            int r5 = r1.getEventType()     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
        L_0x000f:
            r6 = 1
        ...
        L_0x0017:
            ...
            goto L_0x009a
        L_0x001a:
            java.lang.String r7 = r1.getName()     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r3 = r7
            r7 = -1
            int r8 = r3.hashCode()     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            switch(r8) {
        ...
        L_0x0028:
            ...
            boolean r6 = r3.equals(r6)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
        ...
        L_0x003c:
            ...
            boolean r8 = r3.equals(r8)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
        ...
        L_0x005d:
            ...
            goto L_0x007f
        L_0x0060:
            r9.parseConstraintSet(r10, r1)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            goto L_0x0093
        L_0x0064:
            androidx.constraintlayout.widget.ConstraintLayoutStates$Variant r6 = new androidx.constraintlayout.widget.ConstraintLayoutStates$Variant     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r6.<init>(r10, r1)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            if (r4 == 0) goto L_0x0093
            r4.add(r6)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            goto L_0x0093
        L_0x006f:
            androidx.constraintlayout.widget.ConstraintLayoutStates$State r6 = new androidx.constraintlayout.widget.ConstraintLayoutStates$State     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r6.<init>(r10, r1)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r4 = r6
            android.util.SparseArray<androidx.constraintlayout.widget.ConstraintLayoutStates$State> r6 = r9.mStateList     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            int r7 = r4.mId     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r6.put(r7, r4)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            goto L_0x0093
        L_0x007d:
            goto L_0x0093
        L_0x007e:
            goto L_0x0093
        L_0x007f:
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r7.<init>()     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            java.lang.String r8 = "unknown tag "
            r7.append(r8)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r7.append(r3)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            java.lang.String r7 = r7.toString()     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            android.util.Log.v(r6, r7)     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
        L_0x0093:
            goto L_0x009a
        L_0x0094:
            java.lang.String r6 = r1.getName()     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r2 = r6
        L_0x009a:
            int r6 = r1.next()     // Catch:{ XmlPullParserException -> 0x00a7, IOException -> 0x00a2 }
            r5 = r6
            goto L_0x000f
        L_0x00a1:
            goto L_0x00ab
