...
public class StateSet {
    ...
    private void load(android.content.Context r12, org.xmlpull.v1.XmlPullParser r13) {
        ...
        L_0x007d:
            ...
            goto L_0x009b
        L_0x0080:
            androidx.constraintlayout.widget.StateSet$Variant r7 = new androidx.constraintlayout.widget.StateSet$Variant     // Catch:{ XmlPullParserException -> 0x00c3, IOException -> 0x00be }
            ...
            goto L_0x00af
        L_0x008b:
            androidx.constraintlayout.widget.StateSet$State r7 = new androidx.constraintlayout.widget.StateSet$State     // Catch:{ XmlPullParserException -> 0x00c3, IOException -> 0x00be }
            r7.<init>(r12, r13)     // Catch:{ XmlPullParserException -> 0x00c3, IOException -> 0x00be }
            r5 = r7
            android.util.SparseArray<androidx.constraintlayout.widget.StateSet$State> r7 = r11.mStateList     // Catch:{ XmlPullParserException -> 0x00c3, IOException -> 0x00be }
        ...
        L_0x009b:
            ...
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x00c3, IOException -> 0x00be }
            r8.append(r3)     // Catch:{ XmlPullParserException -> 0x00c3, IOException -> 0x00be }
