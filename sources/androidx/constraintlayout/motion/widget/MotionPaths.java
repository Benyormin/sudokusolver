        ...
        while (true) {
            ...
            if (i2 < dArr.length) {
                ...
                if (!Float.isNaN(path_rotate)) {
                    ...
                    float f = dv_x;
                    double d4 = (double) rot;
                    float f2 = dv_y;
                    float f3 = dv_width;
                    double d5 = (double) path_rotate;
                    float f4 = dv_height;
                    float f5 = delta_path;
                    float f6 = rot;
                    float f7 = dy;
                    double degrees = Math.toDegrees(Math.atan2((double) dy, (double) ((dv_width / 2.0f) + dv_x)));
                    Double.isNaN(d5);
                    Double.isNaN(d4);
                    view2.setRotation((float) (d4 + d5 + degrees));
