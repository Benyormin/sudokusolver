...
public class MotionScene {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x008d, code lost:
        androidx.constraintlayout.motion.widget.MotionScene.Transition.access$1300(r4).add(new androidx.constraintlayout.motion.widget.KeyFrames(r12, r1));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00f5, code lost:
        if (r11.mCurrentTransition != null) goto L_0x0110;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:50:0x00fb, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$1200(r4) != false) goto L_0x0110;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:52:0x0103, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$200(r4) == null) goto L_0x0110;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x0114, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$1200(r4) == false) goto L_0x0142;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x011a, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$000(r4) != -1) goto L_0x011f;
     */
    ...
    private void load(android.content.Context r12, int r13) {
        /*
            ...
            r3 = 0
            r4 = 0
            int r5 = r1.getEventType()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        L_0x000f:
            r6 = 1
            ...
            }     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        L_0x0015:
            goto L_0x0149
        L_0x0017:
            r3 = 0
            goto L_0x0149
        L_0x001a:
            java.lang.String r7 = r1.getName()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r3 = r7
            boolean r7 = r11.DEBUG_DESKTOP     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r7 == 0) goto L_0x0039
            java.io.PrintStream r7 = java.lang.System.out     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r8.<init>()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r9 = "parsing = "
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r8.append(r3)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r8 = r8.toString()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r7.println(r8)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        L_0x0039:
            int r7 = r3.hashCode()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r8 = -1
            java.lang.String r9 = "MotionScene"
            switch(r7) {
                case -1349929691: goto L_0x007d;
        ...
        L_0x0044:
            ...
            boolean r6 = r3.equals(r6)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 == 0) goto L_0x0043
            r6 = 4
            goto L_0x0088
        L_0x004e:
            boolean r6 = r3.equals(r9)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 == 0) goto L_0x0043
            r6 = 0
            goto L_0x0088
        L_0x0056:
        ...
        L_0x006a:
            ...
            boolean r7 = r3.equals(r7)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        ...
        L_0x008b:
            goto L_0x012e
        L_0x008d:
            androidx.constraintlayout.motion.widget.KeyFrames r6 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.<init>(r12, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.util.ArrayList r7 = r4.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r7.add(r6)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x009b:
            r11.parseConstraintSet(r12, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x00a0:
            androidx.constraintlayout.widget.StateSet r6 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.<init>(r12, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r11.mStateSet = r6     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x00a9:
            r4.addOnClick(r12, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x00ae:
            if (r4 != 0) goto L_0x00dd
            android.content.res.Resources r6 = r12.getResources()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r6 = r6.getResourceEntryName(r13)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            int r7 = r1.getLineNumber()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r8.<init>()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r10 = " OnSwipe ("
            r8.append(r10)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r8.append(r6)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r10 = ".xml:"
            r8.append(r10)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r8.append(r7)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r10 = ")"
            r8.append(r10)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r8 = r8.toString()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            android.util.Log.v(r9, r8)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        L_0x00dd:
            androidx.constraintlayout.motion.widget.TouchResponse r6 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            androidx.constraintlayout.motion.widget.MotionLayout r7 = r11.mMotionLayout     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.<init>(r12, r7, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r4.mTouchResponse = r6     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x00e8:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r11.mTransitionList     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r7 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r7.<init>(r11, r12, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r4 = r7
            r6.add(r7)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 != 0) goto L_0x0110
            boolean r6 = r4.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 != 0) goto L_0x0110
            r11.mCurrentTransition = r4     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            androidx.constraintlayout.motion.widget.TouchResponse r6 = r4.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 == 0) goto L_0x0110
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            androidx.constraintlayout.motion.widget.TouchResponse r6 = r6.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            boolean r7 = r11.mRtl     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.setRTL(r7)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        L_0x0110:
            boolean r6 = r4.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 == 0) goto L_0x0142
            int r6 = r4.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 != r8) goto L_0x011f
            r11.mDefaultTransition = r4     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0124
        L_0x011f:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r11.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.add(r4)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        L_0x0124:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r11.mTransitionList     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.remove(r4)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x012a:
            r11.parseMotionSceneTags(r12, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x012e:
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r7 = "WARNING UNKNOWN ATTRIBUTE "
            r6.append(r7)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.append(r3)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            java.lang.String r6 = r6.toString()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            android.util.Log.v(r9, r6)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        L_0x0142:
            goto L_0x0149
        L_0x0143:
            java.lang.String r6 = r1.getName()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r2 = r6
        L_0x0149:
            int r6 = r1.next()     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r5 = r6
            goto L_0x000f
        L_0x0150:
            goto L_0x015a
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x004e, code lost:
        if (r8.equals("deriveConstraintsFrom") != false) goto L_0x0052;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void parseConstraintSet(android.content.Context r14, org.xmlpull.v1.XmlPullParser r15) {
        ...
        L_0x0036:
            int r10 = r8.hashCode()
            switch(r10) {
                case -1496482599: goto L_0x0048;
                case 3355: goto L_0x003e;
