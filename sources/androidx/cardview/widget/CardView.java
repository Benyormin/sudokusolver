    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!(cardViewImpl instanceof CardViewApi21Impl)) {
            ...
            switch (heightMode) {
                case Integer.MIN_VALUE:
                case BasicMeasure.EXACTLY /*1073741824*/:
                    heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) cardViewImpl.getMinHeight(this.mCardViewDelegate)), View.MeasureSpec.getSize(heightMeasureSpec)), heightMode);
                    break;
            }
