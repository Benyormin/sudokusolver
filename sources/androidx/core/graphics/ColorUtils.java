...
public final class ColorUtils {
    ...
    public static Color compositeColors(Color foreground, Color background) {
        Color s;
        if (ColorUtils$$ExternalSynthetic0.m0(foreground.getModel(), background.getModel())) {
            if (ColorUtils$$ExternalSynthetic0.m0(background.getColorSpace(), foreground.getColorSpace())) {
                s = foreground;
            } else {
