...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x0082:
            ...
            r7.setSelectedIndicatorHeight(r1)
            ...
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x01c0 }
            int r2 = r1.getDimensionPixelSize(r2, r6)     // Catch:{ all -> 0x01c0 }
            float r2 = (float) r2     // Catch:{ all -> 0x01c0 }
            r10.tabTextSize = r2     // Catch:{ all -> 0x01c0 }
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x01c0 }
            android.content.res.ColorStateList r2 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (android.content.res.TypedArray) r1, (int) r2)     // Catch:{ all -> 0x01c0 }
            r10.tabTextColors = r2     // Catch:{ all -> 0x01c0 }
            r1.recycle()
    ...
    public void setSelectedTabIndicator(Drawable tabSelectedIndicator2) {
        if (this.tabSelectedIndicator != tabSelectedIndicator2) {
            this.tabSelectedIndicator = tabSelectedIndicator2 != null ? tabSelectedIndicator2 : new GradientDrawable();
        }
    }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        private void jumpIndicatorToSelectedPosition() {
            ...
            access$1200.setIndicatorBoundsForTab(tabLayout, currentView, tabLayout.tabSelectedIndicator);
        }
        ...
        public void tweenIndicatorPosition(View startTitle, View endTitle, float fraction) {
            if (startTitle != null && startTitle.getWidth() > 0) {
                TabIndicatorInterpolator access$1200 = TabLayout.this.tabIndicatorInterpolator;
                TabLayout tabLayout = TabLayout.this;
                access$1200.setIndicatorBoundsForOffset(tabLayout, startTitle, endTitle, fraction, tabLayout.tabSelectedIndicator);
            } else {
